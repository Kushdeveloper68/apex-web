  ...
  return (
    ...
    >
      <div className="layout-container flex h-full grow flex-col">
          ...
          >
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="flex-1 flex flex-col gap-6">
                <div
                  className="inline-block px-3 py-1 rounded-full bg-accent/10 text-accent text-xs font-bold uppercase tracking-widest"
                >
                  Material Science
                </div>
                <h2
                  className="text-[#161413] dark:text-white text-4xl font-black leading-tight tracking-tight"
                >
                ...
                >
                  Composite decking is a high-tech material engineered from a
                  precise blend of 95% recycled wood fibers and plastic films.
                  Unlike traditional timber, it mimics the natural grain of wood
                  while providing a protective "cap" that resists the elements.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                  <div className="flex flex-col gap-2">
                    <div
                      className="flex items-center gap-2 text-primary dark:text-accent"
                    >
                      <span className="material-symbols-outlined text-xl"
                        >biotech</span
                      >
                      <span className="font-bold">Engineered Core</span>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Structural integrity that prevents warping and rot.
                    </p>
                  </div>
                  <div className="flex flex-col gap-2">
                    <div
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Redirecting thousands of tons of plastic from landfills
                      annually.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex-1 w-full">
                <div className="relative group">
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `url('https://lh3.googleusercontent.com/aida-public/AB6AXuBw4UQsgEBvuIZ8Vm7QQ35jkvdA8aGarXZtIkT6SmhodGWOeeBQxUsk0sYc0LfzM5xxAXnTxKTu41R7IbiRum_kMwcLCQldUoyWy5xeACmCTDMiMghFru9fZhOhZK2koQ5kp1DHq9Onww8qsbNpF_8-rAzbRqHVPEU4KQloomeWvM_wRmx5MReJ5L_v1g-7Lzdp9qicqz_BgAem2i88t5YRSJy3aAEt4gZke-K0tfQdxseN1N_Z18ypAevSzJj2xNBirsPt0SIcM5c')`
                    }}
                  ></div>
                </div>
              </div>
        ...
        {/* <!-- TextGrid: Benefits --> */}
        <div
          className="flex flex-1 justify-center py-16 bg-background-light dark:bg-background-dark/50"
        >
          <div
            className="layout-content-container flex flex-col w-full max-w-[1280px] px-4"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    Advanced UV inhibitors ensure your deck stands up to harsh
                    sun and heavy rain without fading or cracking.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p
                    className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed"
                  >
                    Enjoy peace of mind with our 25-year industry-leading
                    premium residential warranty against stains and fades.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p
                    className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed"
                  >
                    Never stain, seal, or paint again. A simple soap and water
                    wash is all it takes to keep it looking brand new.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p
                    className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed"
                  >
                    Available in a rich palette of multi-tonal colors and deep
                    wood-grain textures to complement your home.
                  </p>
                </div>
              </div>
            </div>

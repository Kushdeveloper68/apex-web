  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
      <div className="layout-container flex h-full grow flex-col">
                ...
                >
                  <div className="flex flex-col gap-4 text-left max-w-[800px]">
                    <h1 className="text-white text-5xl font-black leading-tight tracking-[-0.033em] @[480px]:text-6xl">
                      ...
                      <span className="text-accent">Premium</span> Composite
                      Decking
                    </h1>
                    <h2 className="text-gray-200 text-lg font-normal leading-relaxed @[480px]:text-xl">
                  ...
                  <div className="flex gap-4">
                    <button className="flex min-w-[200px] cursor-pointer items-center justify-center rounded-lg h-14 px-8 bg-accent text-white text-base font-bold tracking-wide hover:scale-105 transition-transform">
                      Start Your Project
                    </button>
                    <button className="flex min-w-[200px] cursor-pointer items-center justify-center rounded-lg h-14 px-8 bg-white/10 backdrop-blur-md border border-white/20 text-white text-base font-bold hover:bg-white/20 transition-all">
                      View Gallery
                    </button>
                  </div>
                </div>
        ...
        <div className="flex flex-1 justify-center py-16 bg-white dark:bg-background-dark">
          <div className="layout-content-container flex flex-col w-full max-w-[1280px] px-4">
            ...
            <div className="mt-12 flex justify-center">
              <button className="border-2 border-primary text-primary dark:border-white dark:text-white hover:bg-primary hover:text-white px-8 py-3 rounded-lg font-bold transition-all">
                View Full Gallery
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-1 justify-center py-20 px-4">
          <div className="layout-content-container flex flex-col w-full max-w-[1100px]">
            <div className="bg-primary rounded-3xl p-12 relative overflow-hidden flex flex-col items-center text-center">
              {/* <!-- Decorative circle --> */}
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button className="bg-accent text-white px-10 py-4 rounded-xl font-extrabold text-lg hover:shadow-2xl hover:-translate-y-1 transition-all">
                    Request a Free Quote
                  </button>
                  <button className="bg-white text-primary px-10 py-4 rounded-xl font-extrabold text-lg hover:bg-gray-100 transition-all">
                    Call (555) APEX-DECK
                  </button>
                </div>

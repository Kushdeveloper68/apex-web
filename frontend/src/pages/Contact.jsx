    ...
    <>
      ...
      <main className="max-w-[1200px] mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-[#25211e] p-8 rounded-xl shadow-sm border border-[#e2e0df] dark:border-[#333]">
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-[#25211e] p-8 rounded-xl border border-[#e2e0df] dark:border-[#333]">
      ...
      {/* <!-- Map Section --> */}
      <section className="w-full bg-white dark:bg-background-dark py-12 border-t border-[#e2e0df] dark:border-[#333]">
        <div className="max-w-[1200px] mx-auto px-4">
          <h2 className="text-2xl font-bold mb-8">Our Service Presence</h2>
          <div className="w-full h-[400px] bg-gray-200 dark:bg-[#333] rounded-xl overflow-hidden relative group">
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div className="relative">
                  <div className="absolute -top-12 -left-4 bg-white dark:bg-[#25211e] px-4 py-2 rounded-lg shadow-xl border border-primary/20 text-xs font-bold whitespace-nowrap">
            ...
            <div className="absolute bottom-6 right-6 bg-white/90 dark:bg-background-dark/90 p-4 rounded-lg shadow-lg backdrop-blur text-sm font-semibold border border-white/20">

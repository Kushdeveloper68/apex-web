              ...
              {[
                {
                  ...
                  description:
                    "Meticulous attention to detail in every sanding and finishing stroke for a flawless touch.",
                },
                {
                  icon: "construction",
                  title: "Expert Install",
                  description:
                    "Our master carpenters ensure structural integrity that lasts for decades, not years.",
                },
                {
                  icon: "design_services",
                  title: "Custom Design",
                  description:
                    "No templates here. Every project is designed from scratch to match your home's unique soul.",
                },
                {
                  icon: "security",
                  title: "5-Year Warranty",
                  description:
                    "We stand behind our work with a comprehensive guarantee on all workmanship and hardware.",
                },
              ].map((item, index) => (

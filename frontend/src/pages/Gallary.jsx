  ...
  return (
    <main className="flex-1 max-w-[1200px] mx-auto w-full px-6 py-12">
      ...
      <div className="flex flex-col gap-4 mb-12 text-center">
        <h1 className="text-[#161413] dark:text-white text-5xl font-black leading-tight tracking-[-0.033em]">
          Crafting Outdoor Excellence
        </h1>
        <p className="text-[#7c746e] dark:text-[#a39d99] text-lg max-w-2xl mx-auto">
      ...
      <div className="flex justify-center gap-2 mb-10 overflow-x-auto pb-4 scrollbar-hide">
        <button className="flex h-10 shrink-0 items-center justify-center rounded-full bg-primary text-white px-6 text-sm font-bold shadow-sm">
          All Projects
        </button>
        <button className="flex h-10 shrink-0 items-center justify-center rounded-full bg-white dark:bg-[#2a2724] text-[#161413] dark:text-white px-6 text-sm font-semibold hover:bg-primary/10 transition-colors border border-[#e5e5e5] dark:border-[#33302e]">
          Decking
        </button>
        <button className="flex h-10 shrink-0 items-center justify-center rounded-full bg-white dark:bg-[#2a2724] text-[#161413] dark:text-white px-6 text-sm font-semibold hover:bg-primary/10 transition-colors border border-[#e5e5e5] dark:border-[#33302e]">
          Cladding
      ...
      <div className="masonry-grid gap-6 space-y-6">
        {/* <!-- Project Item 1 --> */}
        <div className="relative group overflow-hidden rounded-xl bg-gray-200 break-inside-avoid">
          <img
      ...
      {/* <!-- CTASection --> */}
      <div className="mt-24 mb-12 bg-white dark:bg-[#211e1b] rounded-2xl p-8 md:p-16 text-center border border-[#e5e5e5] dark:border-[#33302e]">
        <h2 className="text-[#161413] dark:text-white text-3xl md:text-4xl font-black mb-4">
          Inspired by our work?
        </h2>
        <p className="text-[#7c746e] dark:text-[#a39d99] text-lg mb-8 max-w-xl mx-auto">
          Let's collaborate on your next outdoor masterpiece. Our design
          consultations are tailored to your vision.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="bg-primary text-white px-8 py-4 rounded-lg font-bold hover:bg-opacity-90 transition-all flex items-center justify-center gap-2">
            <span className="material-symbols-outlined">calendar_today</span>
            Book a Consultation
          </button>
          <button className="bg-transparent border-2 border-primary text-primary px-8 py-4 rounded-lg font-bold hover:bg-primary hover:text-white transition-all">
            View More Services
          </button>
        </div>
      </div>

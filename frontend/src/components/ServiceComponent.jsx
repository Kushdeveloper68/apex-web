...
let services = [
  {
    ...
    description:
      "Composite decking is a high-tech material engineered from a precise blend of 95% recycled wood fibers and plastic films. Unlike traditional timber, it mimics the natural grain of wood while providing a protective 'cap' that resists the elements.",
    mainImage:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuBw4UQsgEBvuIZ8Vm7QQ35jkvdA8aGarXZtIkT6SmhodGWOeeBQxUsk0sYc0LfzM5xxAXnTxKTu41R7IbiRum_kMwcLCQldUoyWy5xeACmCTDMiMghFru9fZhOhZK2koQ5kp1DHq9Onww8qsbNpF_8-rAzbRqHVPEU4KQloomeWvM_wRmx5MReJ5L_v1g-7Lzdp9qicqz_BgAem2i88t5YRSJy3aAEt4gZke-K0tfQdxseN1N_Z18ypAevSzJj2xNBirsPt0SIcM5c",
    property: [
      {
        icon: "biotech",
      ...
      },
      {
        ...
        title: "Sustainable",
        description:
          "Redirecting thousands of tons of plastic from landfills annually.",
      },
    ],
    reasons: [
      {
        ...
        description:
          "Advanced UV inhibitors ensure your deck stands up to harsh sun and heavy rain without fading or cracking.",
      },
      {
        icon: "verified_user",
        title: "Unrivaled Longevity ",
        description:
          "Enjoy peace of mind with our 25-year industry-leading premium residential warranty against stains and fades.",
      },
      {
        icon: "mop",
        title: "Low Maintenance ",
        description:
          "Never stain, seal, or paint again. A simple soap and water wash is all it takes to keep it looking brand new.",
      },
      {
        icon: "palette",
        title: " Architectural Style",
        description:
          "Available in a rich palette of multi-tonal colors and deep wood-grain textures to complement your home.",
      },
    ],
  },
];
  ...
  return (
    <>
      <div className="flex flex-1 justify-center py-12">
        <div className="layout-content-container flex flex-col w-full max-w-[1280px] px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 flex flex-col gap-6">
              ...
              <p className="text-[#4d4844] dark:text-gray-400 text-lg leading-relaxed">
            ...
            <div className="flex-1 w-full">
              <div className="relative group">
                <div className="absolute -inset-2 bg-accent/20 rounded-xl blur-xl group-hover:bg-accent/30 transition-all duration-500"></div>
                <div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services[serviceIndex].reasons.map((item, index) => (
              <div
                ...
                key={index}
              >
                <div className="text-accent bg-accent/10 w-12 h-12 rounded-lg flex items-center justify-center group-hover:bg-accent group-hover:text-white transition-all">
